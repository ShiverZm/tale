  ...
  new Vue({
    ...
    data: function () {
      ...
      return {
        ...
        inputURL: 'http://127.0.0.1:9000/templates/themes/Kratos/static/images/picture.jpg',
        outputURL: 'http://127.0.0.1:9000/templates/themes/Kratos/static/images/picture.jpg',
        input: {},
        output: {},
      };
    },
    ...
    mounted: function () {
      ...
      // xhr.open('GET', 'http://127.0.0.1:9000/templates/static/images/picture.jpg');
